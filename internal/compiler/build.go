...
func compileRuntimeObjects(ctx context.Context, cache *toolchain.ObjectCache, root, opt string) ([]string, int, int, error) {
	sources := []string{"core/object.c", "core/jsvalue.c", "concurrency/scheduler.c", "concurrency/task.c", "concurrency/channel_f64.c", "concurrency/timer.c", "concurrency/blocking_pool.c"}
