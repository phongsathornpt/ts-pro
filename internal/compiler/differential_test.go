...
func TestNativeOutputMatchesTypeScriptReference(t *testing.T) {
	...
	fixtures := []string{
		"fib.ts", "scalars.ts", "loops.ts", "arrays.ts", "array_writes.ts", "dynamic_any.ts", "dynamic_any_call.ts", "dynamic_any_bool.ts", "dynamic_any_nullish.ts", "dynamic_any_refs.ts", "dynamic_union.ts", "dynamic_ops.ts", "dynamic_unbox.ts", "dynamic_property_get.ts", "dynamic_property_set.ts", "dynamic_object_coercion.ts",
