...
func TestNativeOutputMatchesTypeScriptReference(t *testing.T) {
	...
	fixtures := []string{
		"fib.ts", "scalars.ts", "loops.ts", "do_while.ts", "arrays.ts", "array_writes.ts", "string_arrays.ts", "object_arrays.ts", "function_arrays.ts", "nested_arrays.ts", "any_arrays.ts", "union_arrays.ts", "dynamic_any.ts", "dynamic_any_call.ts", "dynamic_any_bool.ts", "dynamic_any_nullish.ts", "dynamic_any_refs.ts", "dynamic_union.ts", "dynamic_ops.ts", "dynamic_unbox.ts", "dynamic_property_get.ts", "dynamic_property_set.ts", "dynamic_call.ts", "dynamic_object_coercion.ts",
