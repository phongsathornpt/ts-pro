...
func (n Node) Text() (string, bool) {
	...
	case KindNumericLiteral, KindStringLiteral, KindRegularExpressionLiteral, KindSourceFile,
		KindNoSubstitutionTemplateLiteral, KindTemplateHead, KindTemplateMiddle, KindTemplateTail:
