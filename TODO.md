      ...
      - [~] Add `finally`, broader nested rejection recovery tests, and selected Promise combinators.
        ...
        - [~] Add broader nested recovery tests and selected Promise combinators.
          ...
          - [~] Add Promise adoption/thenable assimilation plus selected aggregate combinators (`Promise.all` / `Promise.race`).
            ...
            - [~] Add thenable assimilation. Structural thenables now support receiver-correct `this`, resolve/reject, first-settlement-wins, and escaping/asynchronous callbacks through heap-backed callback closures and pending TaskRef settlement under GC stress; broader PromiseLike callback signatures remain.
            - [~] Add homogeneous `Promise.all` / `Promise.race`, then heterogeneous tuple results after tuple semantics land.
              ...
              - [~] Extend aggregates to homogeneous reference/bool results, raw value + PromiseLike inputs, non-literal iterables, and heterogeneous tuple results.
                ...
                - [~] Add raw value + PromiseLike inputs, non-literal iterables, and heterogeneous tuple results.
                  ...
                  - [~] Add structural PromiseLike/thenable assimilation. One/two-callback function-property thenables now support synchronous and escaping/asynchronous settlement; broader PromiseLike callback signatures and additional structural forms remain.
...
1. Extend structural `PromiseLike` assimilation to broader callback signatures and additional structural forms beyond the implemented one/two-callback function-property thenables.
