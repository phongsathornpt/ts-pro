...
func TestFormatBuildReport(t *testing.T) {
	result := compiler.BuildResult{
		Metrics: compiler.BuildMetrics{Values: 10, NativeValues: 9, DynamicValues: 1, BoxingSites: 1, DynamicDispatch: 2, I32Candidates: 5, I64Candidates: 1, I32FastOps: 3, I64FastOps: 1, TaskSpawns: 2, TaskJoins: 1, TaskYields: 1, RuntimeCalls: 7, Shapes: 4},
